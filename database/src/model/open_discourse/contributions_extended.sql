CREATE TABLE open_discourse.contributions_extended (
	id int8 NOT NULL,
	...
	CONSTRAINT contributions_extended_fk FOREIGN KEY (faction_id) REFERENCES open_discourse.factions(id),
	CONSTRAINT contributions_extended_fk_1 FOREIGN KEY (speech_id) REFERENCES open_discourse.speeches(id),

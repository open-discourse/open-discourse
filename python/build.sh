...
speech_content_path=$src_path/04_speech_content
electoral_term_19_path=$src_path/05_electoral_term_19_20
...
python $electoral_term_19_path/01_extract_speeches_and_contributions_electoral_term_19_20.py 2>&1 | tee logs/01_extract_speeches_and_contributions_electoral_term_19_20_log.log
